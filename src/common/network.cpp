...
const NetworkConfig kMainnet{
    ...
    .v5_proposer_expected_num = 1,
    .v5_proposer_expected_den = 1,
    .v5_voter_target_k = 100,
    .v5_round_expand_cap = 8,
    .v5_round_expand_factor = 2,
    .v6_bond_unit = BOND_AMOUNT,
    .v6_units_max = 1'000'000,
    .v6_proposer_expected_num = 1,
    .v6_proposer_expected_den = 1,
